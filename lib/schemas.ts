...
export const UsuarioSchema = z.object({
  ...
  superAdminExpiraEn: z.union([z.date(), z.string()]).nullable().optional(),
  superAdminConcedidoPor: z.string().nullable().optional(),
  superAdminConcedidoEn: z.union([z.date(), z.string()]).nullable().optional(),
  activo: z.boolean().default(true),
