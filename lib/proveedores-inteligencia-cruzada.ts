...
// Tipos, resumen y alertas viven en lib/precios-historicos.ts (puro, sin Firebase) y se
// re-exportan aquí para no mover a los consumidores.
...
import {
  ...
  type ResumenPrecioPiezaProveedor,
  type TipoAlertaPrecio,
} from "@/lib/precios-historicos"

export { evaluarAlertaPrecio, resumirPreciosPorPiezaProveedor }
export type { AlertaPrecio, FuentePrecio, PuntoPrecioHistorico, ResumenPrecioPiezaProveedor, TipoAlertaPrecio }
