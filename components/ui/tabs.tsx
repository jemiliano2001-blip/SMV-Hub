  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:data-[state=active]:bg-transparent group-data-[variant=line]/tabs-list:data-active:bg-transparent dark:group-data-[variant=line]/tabs-list:data-[state=active]:border-transparent dark:group-data-[variant=line]/tabs-list:data-[state=active]:bg-transparent dark:group-data-[variant=line]/tabs-list:data-active:bg-transparent",
        "data-[state=active]:bg-background data-active:bg-background data-[state=active]:text-foreground data-active:text-foreground dark:data-[state=active]:border-input dark:data-active:border-input dark:data-[state=active]:bg-input/30 dark:data-active:bg-input/30 dark:data-[state=active]:text-foreground dark:data-active:text-foreground",
