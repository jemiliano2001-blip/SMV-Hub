...
export default function DetalleVentasSimple({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 p-0 sm:p-4">
      <div className="bg-white w-full sm:max-w-xl sm:rounded-2xl shadow-xl max-h-[92vh] flex flex-col">
        <div className="flex items-start justify-between gap-3 border-b border-slate-100 px-5 py-4">
          ...
          <button
            type="button"
            onClick={onClose}
            className="text-sm font-semibold text-slate-500 hover:text-slate-800 shrink-0"
          >
            Cerrar
          </button>
        </div>
        ...
        <div className="overflow-y-auto px-5 py-4 space-y-4 flex-1">
          ...
          <div className="border-t border-slate-100 pt-4 space-y-3">
            ...
            <button
              ...
              onClick={() => void enviar()}
              className="w-full text-base font-bold py-3 rounded-xl bg-slate-900 text-white disabled:opacity-40"
            >
              Enviar
            </button>
          </div>
