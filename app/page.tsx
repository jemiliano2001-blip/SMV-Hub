...
type GrupoId = 'operacion' | 'compras' | 'finanzas' | 'personal' | 'administracion'
...
const NAV_CARDS: readonly TarjetaNavegacion[] = [
  // ── Fábrica Visual y Operación de Taller ────────────────
  {
    href: 'https://dashboardsmv.web.app/',
    icon: Tv,
    label: 'Dashboard SMV (Fábrica Visual)',
    desc: 'Tablero en vivo para pantallas de taller (TV) con vista rotativa de órdenes activas y estatus de planta.',
    grupo: 'operacion',
    principal: true,
    tags: ['dashboard', 'tv', 'pantalla', 'fabrica', 'visual', 'rotativo', 'ordenes', 'produccion', 'external'],
  },
  {
    href: 'https://smv-vision.web.app/',
    icon: Eye,
    label: 'SMV Visión (Planos & Dibujos)',
    desc: 'Consulta de blueprints (dibujos y medidas técnicas), órdenes por empresa y carga por ingeniero.',
    grupo: 'operacion',
    principal: true,
    tags: ['vision', 'blueprints', 'planos', 'dibujos', 'medidas', 'ingenieros', 'clientes', 'odoo', 'external'],
  },
  {
    href: '/documentos-venta',
    icon: FileText,
    label: 'Documentos de venta',
    desc: 'Pide remisiones o facturas de órdenes de venta y chatea directamente con ventas.',
    grupo: 'operacion',
    principal: true,
    tags: ['remision', 'factura', 'odoo', 'ventas', 'po', 'solicitudes'],
  },
  {
    href: '/pedidos-almacen',
    icon: ClipboardCheck,
    label: 'Pedidos de almacén',
    desc: 'Solicitudes inmediatas de material y herramienta para taller convertibles en compra.',
    grupo: 'operacion',
    principal: true,
    tags: ['almacen', 'pedidos', 'urgente', 'compra', 'taller', 'piso'],
  },
  {
    href: '/almacen',
    icon: Archive,
    label: 'Almacén de materiales',
    desc: 'Control de inventario, entradas, salidas y existencias de materia prima.',
    grupo: 'operacion',
    tags: ['almacen', 'inventario', 'materiales', 'herramienta', 'entradas', 'salidas'],
  },
  {
    href: '/endmills',
    icon: Package,
    label: 'Endmills China',
    desc: 'Inventario, sugerencia de compra y recepción de cortadores CNC en USD.',
    grupo: 'operacion',
    tags: ['endmills', 'cortadores', 'china', 'inventario', 'pedido', 'herramientas', 'cnc'],
  },
  {
    href: '/notificaciones',
    icon: Bell,
    label: 'Notificaciones',
    desc: 'Avisos de pedidos de almacén, requisiciones y documentos del taller.',
    grupo: 'operacion',
    principal: true,
    tags: ['notificaciones', 'avisos', 'alerta', 'taller', 'mensajes'],
  },
  ...
  // ── Compras y Abastecimiento ────────────────────────────
  {
    ...
    desc: 'Escaneo y extracción automática de facturas y tickets mediante IA.',
    grupo: 'compras',
    principal: true,
    tags: ['ia', 'factura', 'compra', 'pdf', 'xml', 'ticket', 'scanner'],
  },
  {
    href: '/compras-odoo',
  ...
  },
  {
    ...
    icon: Package,
    label: 'Ver órdenes',
    desc: 'Bitácora general, búsqueda y seguimiento de compras registradas.',
    grupo: 'compras',
    tags: ['ordenes', 'historial', 'compras', 'proveedores', 'bitacora'],
  },
  {
    href: '/requisiciones',
    icon: ClipboardList,
    ...
    grupo: 'compras',
    tags: ['requisicion', 'solicitud', 'ingenieria', 'automatizacion', 'material'],
  },
  {
    href: '/cotizaciones',
    icon: FileSearch,
    label: 'Cotizaciones',
    desc: 'Base de datos histórica de cotizaciones (México y USA).',
    grupo: 'compras',
    tags: ['cotizacion', 'precios', 'historico', 'proveedores', 'comparativa'],
  },
  {
    href: '/proveedores',
    icon: Building2,
    label: 'Proveedores (USA Tooling)',
    desc: 'Catálogo y comparador de proveedores de herramental e insumos (USA y México).',
    grupo: 'compras',
    tags: ['proveedores', 'usa', 'endmills', 'insertos', 'tooling', 'barato', 'compras', 'mexico'],
  },
  {
    href: '/reportes',
    icon: BarChart3,
    ...
    grupo: 'compras',
    tags: ['reportes', 'kpi', 'excel', 'graficas', 'analisis'],
  },

  // ── Finanzas, Cobranza y SAT ────────────────────────────
  {
    href: '/caja-chica',
    icon: Wallet,
    label: 'Caja Chica',
    desc: 'Fondo fijo, vales de préstamo provisionales y comprobación de gastos.',
    grupo: 'finanzas',
    principal: true,
    tags: ['caja', 'chica', 'fondo', 'fijo', 'vales', 'reembolso', 'efectivo', 'cambio', 'gastos'],
  },
  {
    href: '/finanzas',
    icon: TrendingUp,
    label: 'Resumen financiero',
    desc: 'Indicadores generales de facturación, cuentas por cobrar y flujo.',
    grupo: 'finanzas',
    principal: true,
    tags: ['finanzas', 'odoo', 'ingresos', 'resumen', 'flujo', 'ar'],
  },
  {
    ...
    grupo: 'finanzas',
    tags: ['odoo', 'facturas', 'clientes', 'ventas', 'cfdi'],
  },
  {
    href: '/finanzas/cobranza',
    icon: DollarSign,
    label: 'Control de cobranza',
    desc: 'Promesas de pago, cuentas por cobrar, antigüedad y estatus de cartera.',
    grupo: 'finanzas',
    tags: ['cobranza', 'pagos', 'vencido', 'cartera', 'promesas'],
  },
  {
    href: '/reportes/contable',
    icon: FileSpreadsheet,
    label: 'Reportes Contables SAT',
    desc: 'Resumen fiscal, pólizas contables y cierres de facturación/SAT.',
    grupo: 'finanzas',
    tags: ['reportes', 'contable', 'sat', 'impuestos', 'fiscal', 'cfdi', 'cierre'],
  },
  {
    href: '/claves-sat',
    icon: Search,
    label: 'Claves SAT',
    desc: 'Catálogo y buscador inteligente de claves de productos y servicios del SAT.',
    grupo: 'finanzas',
    tags: ['sat', 'cfdi', 'claves', 'impuestos', 'unspsc', 'catalogo'],
  },
  {
    ...
    grupo: 'finanzas',
    tags: ['reportes', 'finanzas', 'cobros', 'saldos'],
  },

  // ── Personal y Control de Taller ────────────────────────
  {
    href: '/operadores',
    icon: Users,
    label: 'Catálogo de operadores',
    desc: 'Directorio de personal operativo del taller por departamento.',
    grupo: 'personal',
    tags: ['operadores', 'empleados', 'taller', 'personal', 'directorio'],
  },
  {
    href: '/horas-extra',
    icon: Clock,
    label: 'Horas extra',
    desc: 'Captura, control semanal y autorización de horas laboradas extra.',
    grupo: 'personal',
    tags: ['horas', 'extra', 'nomina', 'tiempo', 'semanal', 'autorizacion'],
  },
  {
    href: '/banos',
    icon: Timer,
    label: 'Control de baños',
    desc: 'Registro en tiempo real de uso e incidencias en baños de taller.',
    grupo: 'personal',
    tags: ['banos', 'registro', 'tiempos', 'taller', 'incidencias'],
  },
  {
    href: '/gafetes',
    icon: UserCog,
    ...
    grupo: 'personal',
    tags: ['gafetes', 'credenciales', 'personal', 'foto', 'impresion', 'badge'],
  },
  ...
  // ── Administración del Sistema ───────────────────────────
  {
    ...
    desc: 'Gestión de cuentas de acceso, plantillas y matriz de permisos.',
    grupo: 'administracion',
    tags: ['usuarios', 'roles', 'permisos', 'admin', 'cuentas', 'seguridad'],
  },
  {
    href: '/auditoria',
    icon: ShieldCheck,
    label: 'Bitácora de auditoría',
    desc: 'Registro detallado de acciones, seguridad y eventos del sistema.',
    grupo: 'administracion',
    tags: ['auditoria', 'logs', 'seguridad', 'bitacora', 'historial'],
  },
]
...
const SECCIONES = [
  {
    id: 'operacion',
    titulo: 'Fábrica Visual y Operación de Taller',
    badgeText: 'Piso de Producción',
  ...
  {
    id: 'finanzas',
    titulo: 'Finanzas, Cobranza y SAT',
    badgeText: 'Módulo Financiero',
    badgeStyle: 'bg-emerald-50 text-emerald-700 border-emerald-200',
  },
  {
    id: 'personal',
    titulo: 'Personal y Control de Taller',
