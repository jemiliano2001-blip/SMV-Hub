...
export function TrustLedger({
  ...
  if (compact) {
    return (
      <div
        className="mb-4 flex min-h-11 flex-wrap items-center gap-x-3 gap-y-1 border-y border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 no-print"
      ...
      >
        ...
        {trust.activeRunId ? (
          ...
          <span>{unavailable.description}</span>
        )}
        <Link
          href="/reportes"
  ...
  return (
    <section
      ...
      aria-labelledby="integrity-trust-title"
    >
